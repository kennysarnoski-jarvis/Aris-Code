// This file mostly exists because we want dev mode to say "Aris Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Aris Code (Dev)" : "Aris Code (Alpha)";
...
const developmentMacIconPngPath = join(repoRoot, "assets", "dev", "aris-macos-1024.png");
