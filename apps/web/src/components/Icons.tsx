...
// DeepSeek brand mark — the official whale logo, sourced verbatim from
// the `simple-icons` package (slug: deepseek, brand hex #5786FE). 24x24
// viewBox is simple-icons' standard. Rendered with `fill="currentColor"`
// so the provider picker's tinting (and ultrathink states) still apply;
// `providerIconClassName` can map `deepseek` to the brand blue the same
// way `claudeAgent` maps to terracotta if we want the branded look.
