...
// Promoted from ComposerPromptEditor's private const so it can be reused by
// SkillInlineText (renders skill chips inline in markdown / user messages).
// Ported from t3code #2572.
