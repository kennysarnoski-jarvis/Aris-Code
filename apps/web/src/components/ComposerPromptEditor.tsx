...
// SKILL_CHIP_ICON_SVG moved to ./composerInlineChip (t3code #2572 port) so
// SkillInlineText can render the same icon for inline skill chips in chat.
      ...
      <div className="relative">
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className={cn(
                "block max-h-[200px] min-h-17.5 w-full overflow-y-auto whitespace-pre-wrap break-words bg-transparent text-base leading-relaxed text-foreground focus:outline-none",
                className,
              )}
