...
echo ""
echo -e "  ${BOLD}Heads up:${RESET} Aris Code won't appear in your Apps menu — it's a"
echo -e "  developer build that runs from the terminal. If you'd like it in"
echo -e "  your launcher anyway, the ${BOLD}docs/INSTALL-LINUX.md${RESET} guide in the"
echo -e "  repo walks you through a 30-second .desktop file setup. Same doc"
echo -e "  also covers updating, daily workflow, and troubleshooting."
echo ""
